...
class _ScrollsnapCardDisponibilidadState extends State<ScrollsnapCardDisponibilidad> {
        ...
        Expanded(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            if(!(widget.isAutorActividadVisible) && !widget.disponibilidad.isAutor)
              ...[
                const SizedBox(height: 16,),
                const Text("Crea una actividad y juega seleccionando invitados sin notificar:",
            ...
            if((widget.isAutorActividadVisible) && !widget.disponibilidad.isAutor)
              ...[
                const SizedBox(height: 16,),
                const Text("Selecciona como permitido en tu actividad sin notificarle:",
                  style: TextStyle(color: constants.grey, fontSize: 12, height: 1.3,),
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: 16,),
  ...
  Widget _buildMatchExito(){
    return TextButton(
      onPressed: (){},
      child: const Text("🤝 Seleccionados", style: TextStyle(fontSize: 12),),
